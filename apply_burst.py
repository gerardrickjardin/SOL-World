...
new_component = r"""const HopeEmojiSlider = ({ currentSelection, onSelect, anchors, currentQ }) => {
    ...
    const getGlowStyles = (zone) => {
        if (zone === 1) {
            return displayValue >= 1.0 && displayValue <= 2.0 ? "border-blue-500/30" : "opacity-50 grayscale border-transparent";
        }
        if (zone === 3) {
            return displayValue >= 2.5 && displayValue <= 3.5 ? "border-white/20" : "opacity-50 grayscale border-transparent";
        }
        if (zone === 5) {
            return displayValue >= 4.0 && displayValue <= 5.0 ? "border-purple-500/30" : "opacity-50 grayscale border-transparent";
        }
        return "";
    };
        ...
        <div className="w-full flex flex-col gap-10 bg-[#15191e] p-8 md:p-10 rounded-3xl mb-6 shadow-2xl border border-slate-800 relative overflow-hidden">
            ...
            <div className="grid grid-cols-3 gap-6 md:gap-8 relative z-10">
                ...
                <div className="flex flex-col items-center text-center gap-6 relative">
                    <p className={`text-[12px] md:text-sm h-12 leading-relaxed max-w-[200px] transition-colors duration-300 ${displayValue >= 1.0 && displayValue <= 2.0 ? "text-blue-200" : "text-slate-400"}`}>
                ...
                {/* 3.0 Zone */}
                <div className="flex flex-col items-center text-center gap-6 relative">
                    <p className={`text-[12px] md:text-sm h-12 leading-relaxed max-w-[200px] transition-colors duration-300 ${displayValue >= 2.5 && displayValue <= 3.5 ? "text-slate-200" : "text-slate-400"}`}>
                ...
                {/* 5.0 Zone */}
                <div className="flex flex-col items-center text-center gap-6 relative">
                    <p className={`text-[12px] md:text-sm h-12 leading-relaxed max-w-[200px] transition-colors duration-300 ${displayValue >= 4.0 && displayValue <= 5.0 ? "text-purple-200" : "text-slate-400"}`}>
