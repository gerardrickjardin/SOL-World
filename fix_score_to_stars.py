...
for filepath in files:
    ...
    # The current score display code is:
    old_display = """                                <text x="160" y="30" fill="#ffffff" fontSize="18" fontWeight="bold" textAnchor="middle" letterSpacing="2px">TOTAL HoPE INDEX SCORE</text>
                                ...
                                <text x="140" y="115" fill="#ffffff" fontSize="64" fontWeight="900" textAnchor="middle" filter="url(#glow-intense)"  style={{ fontFamily: 'sans-serif' }}>
                                    {Math.round(((totalScore - 20) / 80) * 100)}
                                </text>
                                <text x="200" y="115" fill="#00e5ff" fontSize="24" fontWeight="bold" textAnchor="start" opacity="0.8">/100</text>"""
                
    new_display = """                                <text x="160" y="30" fill="#ffffff" fontSize="18" fontWeight="bold" textAnchor="middle" letterSpacing="2px">TOTAL HoPE STARS</text>
